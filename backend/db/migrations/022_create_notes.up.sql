...
CREATE INDEX IF NOT EXISTS idx_notes_reminder_recipient_user_id ON notes(reminder_recipient_user_id);
CREATE INDEX IF NOT EXISTS idx_notes_calendar_event_id ON notes(calendar_event_id);
CREATE INDEX IF NOT EXISTS idx_notes_next_follow_up_date ON notes(next_follow_up_date) WHERE reminder_enabled = TRUE;
