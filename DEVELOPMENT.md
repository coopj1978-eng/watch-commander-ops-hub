...
```bash
git remote add encore encore://watch-commander-ops-hub-8spi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/watch-commander-ops-hub-8spi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/watch-commander-ops-hub-8spi/settings/integrations/github)
